<?php include"lib/header.php";
			...
			$id= $_REQUEST['id'];
			//Fetch User Details
			$FetchUserSql = "SELECT * FROM ".TABLE_PREFIX."refer WHERE id = '".$id."'"; 
							...
							<div class="row-fluid">
                               ...
                               <!--<div class="control-group">
                                  ...
                                  <div class="control-group">
                                     ...
                                     <div class="controls">
									 <label class="control-label" style="width:87%; text-align:justify; padding-left:100px;"><?=$rowdest['first_name']?>	</label>
                                     </div>
                                  </div>
                                  ...
                                  <div class="control-group">
                                     ...
                                     <div class="controls">
										 <label class="control-label" style="width:87%; text-align:justify; padding-left:100px;"><?=$rowdest['last_name']?>	</label>
                                      </div>
                                  </div>
                                  ...
                                  <div class="control-group">
                                   ...
                                   <div class="control-group">
                                     ...
                                     <div class="controls">
										 <label class="control-label" style="width:400px; text-align:justify; padding-left:100px;"><?=$rowdest['ph_no']?>	</label>
                                      </div>
                                  </div>
   <!--******************************************************************************************-->  
   								<div class="control-group">
     							...
     							<div class="control-group">
                                     ...
                                     <div class="controls">
									 <label class="control-label" style="width:87%; text-align:justify; padding-left:100px;"><?=$rowdest['refer_firstname']?>	</label>
                                     </div>
                                  </div>
                                  
                                  <div class="control-group">
                                     <label class="control-label">Applicant Last Name : </label>
                                     <div class="controls">
										 <label class="control-label" style="width:87%; text-align:justify; padding-left:100px;"><?=$rowdest['refer_lastname']?>	</label>
                                      </div>
                                  </div>
                                  ...
                                  <div class="control-group">
                                   ...
                                   <div class="control-group">
                                     <label class="control-label">Applicant phone No : </label>
                                     <div class="controls">
										 <label class="control-label" style="width:400px; text-align:justify; padding-left:100px;"><?=$rowdest['ph_no']?>	</label>
                                      </div>
                                  </div>    
                                     ...
                                     <div class="controls">
										 <label class="control-label" style="width:400px; text-align:justify; padding-left:100px;"><?=$rowdest['qualification']?>	</label>
                                      </div>
                                  </div>                         
								  ...
								  <div class="control-group">
                                     <label class="control-label">Apply Date : </label>
									  <div class="controls" style="padding-left:97px;width:17%;">
										 <label class="control-label" style="width:87%;"><?=date("jS M Y h:i a",strtotime($rowdest['date']))?></label>
									  </div>
                                  </div>
