<?php include"lib/header.php";
		...
		if(isset($_REQUEST['submit']) && isset($_REQUEST['action']) && $_REQUEST['action'] == 'add' ) {  
				...
				echo "window.top.location.href='availableShiftList.php?mess=Successful';\n";
				echo "</script>";
				exit();
			...
			if(isset($_REQUEST['submit']) && isset($_REQUEST['action']) && $_REQUEST['action'] == 'edit' ) {  
				...
				echo "<script language=\"JavaScript\" type=\"text/javascript\">\n";
				echo "window.top.location.href='availableShiftView.php?Uid=".$id."&mess=Update';\n";
				echo "</script>";
				exit();
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
						 <li>
						  ...
						  <li>
							<a href="availableShiftList.php">Available Shift List</a> 
							<span class="icon-angle-right"></span>
						 </li>
                               ...
                               <div class="span12 ">
                                  ...
                                  <div class="control-group">
                                     <label class="control-label">Role</label>
									  <div class="controls">
										 <textarea class="span12 ckeditor m-wrap description" name="role" rows="6" ><?=stripslashes($rowdest['role'])?></textarea>
									  </div>
                                  </div>
                                   <div class="control-group">
