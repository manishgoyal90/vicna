						...
						<div id="tablesec">
							<table class="table table-striped table-bordered table-hover" id="sample_2">						
								...
								<?php
									...
									$GetUserSql = "SELECT sas.*, sr.RegistrationNo, sr.FirstName, sr.LastName FROM staff_available_shift as sas INNER JOIN hr_staff_registration as sr ON sr.Uid = sas.accept_staffid AND sas.accept_staffid != '' AND sas.shiftEndTime < NOW() AND sas.timeSheets != '' AND sas.status = 'Processed' ORDER BY sas.id DESC";
