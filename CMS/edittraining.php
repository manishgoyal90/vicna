<?php include"lib/header.php";
		...
		if($_REQUEST['submit']=="Submit") {  
					...
					$unlink_sql = "SELECT cmsimg FROM ".TABLE_PREFIX."training WHERE id = '".$pageid."'";
			 ...
			 $UpdateSql = "UPDATE ".TABLE_PREFIX."training SET
	...
	echo "<script language=\"JavaScript\" type=\"text/javascript\">\n";
				echo "window.top.location.href='training.php?mess=updatesuccessful';\n";
				echo "</script>";
				exit();
			...
			$FetchUserSql = "SELECT * FROM ".TABLE_PREFIX."training WHERE id = '".$pageid."'"; 
			...
			else if(!is_file("../cmsimage/bigimg/".$rowdest['cmsimg']))
			{
				$pic = "images/nopic.jpg";
			}
			else
			{
				$pic = "../cmsimage/bigimg/".$rowdest['cmsimg'];
			}
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
						 <li>
						  ...
						  <li>
							<a href="cms.php">service Page List</a> 
							<span class="icon-angle-right"></span>
						 </li>
					...
					<form name="cmspageform" id="cmspageform" class="form-horizontal" action="<?=$_SERVER['PHP_SELF']?>" method="POST" style="margin:0; padding:0" enctype="multipart/form-data" onSubmit="return check();">
							...
							<div class="row-fluid">
                               <div class="span12 ">
								 ...
								 <!-- <?php if($_REQUEST['pageid']=="9" || $_REQUEST['pageid']=="10" || $_REQUEST['pageid']=="11") { ?>
								  <div class="control-group">
                             ...
                             <!--     <div class="control-group">
                                     <label class="control-label">Name</label>
									  <div class="controls">
										 <input type="text" class="span8 m-wrap" name="cms_pagetitle" id="cms_pagetitle" value="<?=$rowdest['namee']?>" readonly="" />
									  </div>
                                  </div>
                                  <div class="control-group">
                                     <label class="control-label">Post</label>
									  <div class="controls">
										 <input type="text" class="span8 m-wrap" name="cms_pagetitle" id="cms_pagetitle" value="<?=$rowdest['post']?>" readonly="" />
									  </div>
                                  </div>
                                  -->
                               </div>
						   ...
						   <div class="form-actions" style="padding-left:10px">
							  ...
							  <button type="button" class="btn" id="cancel" onClick="location.href='service1.php'">Cancel</button>
						   </div>
