						...
						<div class="portlet box grey">
							...
							<div class="portlet-body">
								<div class="table-toolbar">
									 <div class="btn-group">
										<a class="btn blue" href="blog.php?mode=add">Add New <i class="icon-plus"></i></a>
									</div>
...
<!--	<script src="assets/plugins/bootstrap-modal/js/bootstrap-modal.js" type="text/javascript" ></script>
	...
	{	
		...
		if(cnf)
		{
			...
			$.post('ajax/delpost.php',{ feedid : id, mode : 'single' },
				function(data)
				{//deletecinematic
					$('#tablesec').html(data);
					/************************************ Table JS ************************************/
	...
	function delselected()
	{
		...
		if(str != "")
		{
			...
			{
				$('.portlet .tools a.reload').click();
				$.post('ajax/delpost.php',{ feedids : str , mode : 'selected' },
					function(data)
					{
						$('#tablesec').html(data);
	...
	{
		$.post('ajax/statuspost.php',{ stat : stat , id : id });
	}
</script>
	<!-- END JAVASCRIPTS -->
</body>
