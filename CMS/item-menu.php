    ...
    <div class="container-fluid">
      ...
      <div class="row-fluid">
        <div class="span12">
          ...
          <h3 class="page-title"> Work with Vicna </h3>
          <ul class="breadcrumb">
              ...
              <div id="tablesec">
                <table class="table table-striped table-bordered table-hover" id="sample_2">
                  ...
                  <tbody>
                    <?php
						...
						$sql="SELECT * FROM item_menu";
									$res=mysql_query($sql);
									$count=mysql_num_rows($res);
												
						$GetUserSql = "SELECT * FROM hr_contact ORDER BY id DESC";
				...
				?>
                    <tr class="odd gradeX">
                     ...
                     <!-- <td class="hidden-480"><div class="videoWrapper">
                          <?= $rowdest['extraqualification'] ?>
                        </div></td>-->
                     
                      <td class="hidden-480"><a onclick="deleteone(<?=$rowdest['id']?>);" class="btn mini red"><i class="icon-trash"></i> Delete</a></td>
                    </tr>
                    <?php $ctn++;
					} ?>
                  </tbody>
...
<script>
    ...
    function deleteone(id)
    {
        ...
        if (cnf)
        {
            ...
            $.post('ajax/delitem.php', {feedid: id, mode: 'single'},
            function(data)
            {//deletecinematic
                $('#tablesec').html(data);
                /************************************ Table JS ************************************/
