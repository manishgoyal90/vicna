<?php include"lib/header.php";
			...
			$ImageId = $_REQUEST['BannerId'];
			//Fetch User Details
			$ctn = 1;
									$GetUserSql = "SELECT * FROM ".TABLE_PREFIX."banner WHERE BannerId = '".$ImageId."'";
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
						 ...
						 <li>
							...
							<a href="BannerList.php">Banner List</a> 
							<span class="icon-angle-right"></span>
						 </li>
			...
			<!-- BEGIN PAGE CONTENT-->
				<div class="row-fluid">
					<div class="span12">
                        ...
                        <div>&nbsp;</div>
					<!-- BEGIN FORM-->
					<form name="videoform" class="form-horizontal" action="comment.php" method="POST" style="margin:0; padding:0" enctype="multipart/form-data" onSubmit="return check();"> 
					<input type="hidden" name="type" value="Photo" />
							<div class="row-fluid">
                               ...
                               <div class="control-group">
                                      <label class="control-label">Banner Photo : </label>
                                      <div class="controls">
                                  ...
                                  <div class="control-group">
                                     ...
                                     <div class="controls">
										 <label class="control-label" style="width:400px; text-align:justify; padding-left:100px;"><?=strtoupper($rowdest['BannerName'])?>	</label>
                                      </div>
                                  </div>
                                   ...
                                   <div class="control-group">
                                     ...
                                     <div class="controls">
										 <label class="control-label" style="width:400px; text-align:justify; padding-left:100px;"><?php if($rowdest['link'] !=""){echo $rowdest['link'];}else{echo 'N/A';}?>	</label>
                                      </div>
                                  </div>
                                  ...
                                  <!-- <div class="control-group">
                                     <label class="control-label">Status : </label>
									  <div class="controls">
										 <label class="control-label" style="width:400px; text-align:left; padding-left:100px;"><?php if($rowdest['BannerStatus']=="Yes") {echo "Active";} else { echo"InActive";}?></label>
									  </div>
                                  </div>-->
                                  ...
                                  <div class="control-group">
                                     <label class="control-label">Descriptions : </label>
									  <div class="controls">
										 <label class="control-label" style="width:400px; text-align:justify; padding-left:100px;"><?=strip_tags(stripslashes($rowdest['BannerDescription']))?></label>
									  </div>
                                  </div>  
                               </div>
                            </div>
