							...
							<div class="row-fluid">
                               <div class="span12 ">
                             	 ...
                             	 <div class="control-group">
                                     <label class="control-label">Superstar Name </label>
									  <div class="controls" style="font-size:18px; font-weight:bold; padding-top:7px;">
									  	<?=strtoupper($rowdest['name'])?>
									  </div>
								 </div>
								  
                               
                               <div class="control-group">
                                      <label class="control-label">Superstar Image </label>
                                      <div class="controls">
                                  ...
                                  <div class="control-group">
                                     <label class="control-label">About Superstar </label>
									  <div class="controls" style="padding-top:7px;">
									  	<?=stripslashes($rowdest['description'])?>
									  </div>
								 </div>
								 
								
                                  <div class="control-group">
                                     <label class="control-label">Month of Superstar</label>
									  <div class="controls" style="padding-top:7px;">
									  	<?=$rowdest['month_of_superstar'];?>
