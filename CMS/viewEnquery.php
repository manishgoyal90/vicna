<?php include"lib/header.php";
			...
			$id= $_REQUEST['id'];
			//Fetch User Details
			$FetchUserSql = "SELECT * FROM ".TABLE_PREFIX."enquery WHERE id = '".$id."'"; 
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
						 ...
						 <li>
							<a href="enquery.php">View Enquery</a> 
							<span class="icon-angle-right"></span>
						 </li>
                               ...
                               <!--<div class="control-group">
                                  ...
                                  <div class="control-group">
								   ...
								   <div class="control-group">
                                     ...
                                     <div class="controls">
										 <label class="control-label" style="width:400px; text-align:justify; padding-left:100px;"><?=$rowdest['position']?>	</label>
                                      </div>
                                  </div>
								   <div class="control-group">
                                     <label class="control-label">Organization: </label>
                                     <div class="controls">
										 <label class="control-label" style="width:400px; text-align:justify; padding-left:100px;"><?=$rowdest['organization']?>	</label>
                                      </div>
                                  </div>
								   <div class="control-group">
                                  ...
                                  <div class="control-group">
                                     <label class="control-label">Call Back : </label>
                                     <div class="controls">
										 <label class="control-label" style="width:400px; text-align:justify; padding-left:100px;"><?=$rowdest['callback']?>	</label>
                                      </div>
                                  </div>   
								  
								  <div class="control-group">
                                     <label class="control-label">Enquery Date : </label>
                                     <div class="controls">
