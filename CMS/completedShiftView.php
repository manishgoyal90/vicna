...
if(isset($_REQUEST['submit'])) {	                         
	...
	if($update)
	{
		...
		echo '<script>window.location.href="advertiseShiftView.php?Uid='.$id.'";</script>';
		exit();
	}
				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="completedShifts.php">Completed Shifts</a> 
								<i class="icon-angle-right"></i>
							</li>
							<li>
								<a href=""><?=$pagetitle?></a>
								...
								<div class="tab-pane row-fluid active" id="tab_1_1">
									...
									<div class="span9">
										<div class="row-fluid"  id="view_profile">
                                            ...
                                            <h3>Completed Shift Info</h3>	
												<table  width="100%" cellpadding="3" rules="none" border="0">
													
													 <tr>
														<td><p><i class="icon-star"></i>&nbsp;Shift Allocated to
															</p></td>
														<td><p>:</p></td>
														<td rowspan="2">
                                                        <?php 
														...
														?>
                                                        	<p style="font-weight:bold; color:#993300; font-size:16px;">
                                                            <?=strtoupper($fetch['FirstName'].' '.$fetch['LastName']);?></br>
                                                            Employee ID : <?=$fetch['RegistrationNo'];?>
													...
													<tr>
														<td><p><i class="icon-star"></i>&nbsp;Shift Status</p></td>
														<td><p>:</p></td>
														<td><p style="color:#CC6600; font-weight:bold;"><?= stripslashes($rowdest7['status']) ;?></p></td>
													</tr>	
													
													<tr>
														<td><p><i class="icon-star"></i>&nbsp;Time Sheet</p></td>
														<td><p>:</p></td>
														<td><p>
														<?php if($rowdest7['timeSheets'] != ""){?>
															<a title="Download Timesheet" href="../download.php?path=Timesheet&file=<?=$rowdest7['timeSheets'];?>"><img src="../img/time_sheet.png" height="100" /></a>
														<?php }else{?>
															<span style="color:#FF0000; font-size:18px; font-weight:bold;">Timesheet Due</span>
														<?php }?>
