<?php include"lib/header.php";
		...
		$UpdateSql = "UPDATE ".TABLE_PREFIX."cms1 SET
														title1 = '".addslashes($_REQUEST['title1'])."',
														text1 = '".addslashes($_REQUEST['cms_pagedes1'])."',
														title2 = '".addslashes($_REQUEST['title2'])."',
														text2 = '".addslashes($_REQUEST['cms_pagedes2'])."',
														title3 = '".addslashes($_REQUEST['title3'])."',
														text3 = '".addslashes($_REQUEST['cms_pagedes3'])."',
														title4 = '".addslashes($_REQUEST['title4'])."',
														text4 = '".addslashes($_REQUEST['cms_pagedes4'])."',
														title5 = '".addslashes($_REQUEST['title5'])."',
														text5 = '".addslashes($_REQUEST['cms_pagedes5'])."',
														title6 = '".addslashes($_REQUEST['title6'])."',
			...
			$FetchUserSql = "SELECT * FROM ".TABLE_PREFIX."cms1 WHERE id = '".$pageid."'"; 
								  ...
								  <div class="control-group">
								   ...
								   <div class="control-group">
                                     <label class="control-label">Description 7</label>
									  <div class="controls">
										 <textarea class="span12 ckeditor m-wrap" name="cms_pagedes" rows="6" id="cms_pagedes7"><?=stripslashes($rowdest['text1'])?></textarea>
										  <p id="remain7"></p>
									  </div>
								   ...
								   <div class="control-group">
                                     <label class="control-label">Description 8</label>
									  <div class="controls">
										 <textarea class="span12 ckeditor m-wrap" name="cms_pagedes" rows="6" id="cms_pagedes8"><?=stripslashes($rowdest['text1'])?></textarea>
										 <p id="remain8"></p>
									  </div>
...
<!--   	<script src="assets/scripts/table-managed.js"></script>
	...
	var charLmt2 = "170";//max charterer 
	...
	var charLmt3 = "200";//max charterer 
	...
	var charLmt4 = "200";//max charterer 
	...
	var charLmt5 = "200";//max charterer 
	...
	var charLmt6 = "150";//max charterer 
