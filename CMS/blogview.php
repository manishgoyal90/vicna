<?php include"lib/header.php";
		...
		if($_REQUEST['submit']=="Submit Comment") {
			...
			echo "window.top.location.href='blogview.php?PostId=".$_REQUEST['PostId']."&action=addcommentsuccessful';\n";
			echo "</script>";
			exit();	
	}
		...
		if($_REQUEST['submit']=="Submit Reply") {
			...
			echo "<script language=\"JavaScript\" type=\"text/javascript\">\n";
			echo "window.top.location.href='blogview.php?PostId=".$_REQUEST['PostId']."&action=addreplysuccessful&cmid=".$_REQUEST['comentid']."';\n";
			echo "</script>";
			exit();	
		}
                   ...
                   <input type="hidden" name="mailid" value="<?=$BidFetch['MailAddress']?>" />
							...
							<div class="row-fluid">
                               ...
                               <div class="control-group">
                                 ...
                                 <!-- <div class="control-group">
                                  ...
                                  <div class="control-group">
                                     ...
                                     <div class="controls">
										 <label class="control-label" style="width:87%; text-align:justify; padding-left:100px;"><?=$rowdest['PostTitle']?>	</label>
                                      </div>
                                  </div>
                               ...
                               <!--   <div class="control-group">
                                     ...
                                     <div class="controls">
										 <label class="control-label" style="width:87%; text-align:justify; padding-left:100px;"><?=$rowdest['PostedBy']?>	</label>
                                      </div>
                                  </div>-->
...
<!--                                   <div class="control-group">
                                     ...
                                     <div class="controls">
										 <label class="control-label" style="width:400px; text-align:justify; padding-left:100px;"><?=$rowdest['Author']?>	</label>
                                      </div>
                                  </div>-->
								  ...
								  <div class="control-group">
                                     <label class="control-label">Date : </label>
									  <div class="controls" style="padding-left:97px;width:17%;">
										 <label class="control-label" style="width:87%;"><?=date("jS M Y h:i a",strtotime($rowdest['PostDate']))?></label>
									  </div>
                                  </div>
                                   ...
                                   <div class="control-group">
                                     <label class="control-label">Status : </label>
									  <div class="controls">
										 <label class="control-label" style="width:87%; text-align:left; padding-left:100px;"><?php if($rowdest['PostStatus']=="Yes") {echo "Active";} else { echo"InActive";}?></label>
									  </div>
                                  </div>
                                  ...
                                  <div class="control-group">
                                     <label class="control-label">Descriptions : </label>
									  <div class="controls">
										 <label class="control-label" style="width:87%; text-align:justify; padding-left:100px;"><?=stripslashes($rowdest['PostDescriptions'])?></label>
									  </div>
                                  </div>
                                <?php
								  	//For Display Comment Info
									$SqlCommentDetal = "SELECT * FROM ".TABLE_PREFIX."comment_details WHERE ArticleId = '".$_REQUEST['PostId']."' AND CommentFor = 'Post'";
                                  ...
                                  <!--<div class="control-group" style="padding-top:20px;">
                                     ...
                                     <div style="padding-top:27px;"> <hr /> </div>
									  <div class="controls">
										 <label class="control-label" style="width:100%; text-align:justify; padding-left:100px;">
                                         <table border="0"  class="adsnal_tbl table" style="width:87%;">
                                         <?php
                                            ...
                                            <tr class="odd gradeX">
                                              <td><a class="replay" href="blogview.php?PostId=<?=$_REQUEST['PostId']?>&comentid=<?=$ArrFetchUCom['ComId']?>">reply</a> | <?=$showDate=date('jS M Y  h : i a',strtotime($ArrFetchUCom['ComDate']));?></td>
                                            </tr>
                                             <tr class="odd gradeX">
                                              <td>&nbsp;</td>
                                            </tr>
                                            <?php
													...
													$SqlReplyDetal = "SELECT * FROM ".TABLE_PREFIX."reply_details WHERE ComId = '".$ArrFetchUCom['ComId']."' AND ReplyFor ='Post'";
                                            ...
                                            <tr class="odd gradeX">
                                              <td>&nbsp;</td>
                                              <td>
                                              	<table border="0"  class="adsnal_tbl table" style=" width:100%;">
                                                <?php
                                                    ...
                                                    <?php if($_REQUEST['comentid']==$ArrFetchUCom['ComId']) { ?>
                                                     ...
                                                     <td>&nbsp;</td>
                                                      <td><div style="padding-bottom:15px;">Reply Message : </div>
                                                 		<textarea class="m-wrap" name="reply" rows="6" id="reply" style="width:100%;" /></textarea></td>
                                                    </tr>
                                                    <tr class="odd gradeX">
                                                    	<td>&nbsp;</td>
                                                         <td>
								   ...
								   <div class="control-group">
									 ...
									 <label class="control-label" style="width:87%; text-align:justify; padding-left:67px;">
									 	<div class="control-group">
									  <div class="controls">
									  <div style=" padding-bottom:10px;">Message</div>
										 <textarea class="span12 ckeditor m-wrap" name="comment" rows="6" id="comment"></textarea>
										 <div style="padding-left:0px; padding-top:10px;">
