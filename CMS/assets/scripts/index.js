        ...
        initIntro: function () {
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    title: 'Meet SSU Software Lab!',
                    // (string | mandatory) the text inside the notification
                    text: 'SSU Software Lab is a brand new Responsive Admin Dashboard Template you have always been looking for!',
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    // (string | mandatory) the heading of the notification
                    title: 'Buy SSU Software Lab!',
                    // (string | mandatory) the text inside the notification
                    text: 'SSU Software Lab comes with a huge collection of reusable and easy customizable UI components and plugins. Buy SSU Software Lab today!',
                    // (string | optional) the image to display on the left
                    image: './assets/img/avatar1.jpg',
                    // (bool | optional) if you want it to fade out on its own or just sit there
                    sticky: true,
            ...
            setTimeout(function () {
                ...
                var unique_id = $.gritter.add({
                    position: 'top-left',
                    // (string | mandatory) the heading of the notification
                    title: 'Customize SSU Software Lab!',
                    // (string | mandatory) the text inside the notification
                    text: 'SSU Software Lab allows you to easily customize the theme colors and layout settings.',
                    // (string | optional) the image to display on the left
