var TableManaged = function () {
    ...
    return {
        ...
        init: function () {
            ...
            jQuery('#sample_2_wrapper .dataTables_filter input').addClass("m-wrap big"); // modify table search input
            jQuery('#sample_2_wrapper .dataTables_length select').addClass("m-wrap big"); // modify table per page dropdown
