                ...
                <table class="table table-striped table-bordered table-hover" id="sample_2">
                  <thead>
                    <tr>
					  ...
					  <th class="hidden-480">Apply Date</th>
                  ...
                  <tbody>
					...
					$GetUserSql = "SELECT * FROM hr_apply ORDER BY id DESC";
                    ...
                    <tr class="odd gradeX">
                      ...
                      <td class="hidden-480"><div class="videoWrapper">
                          <?= $rowdest['first_name'].' '.$rowdest['last_name']; ?>
                        </div></td>
                      <td class="hidden-480"><div class="videoWrapper">
                          <?= $rowdest['email'] ?>
                        </div></td>
                      ...
                      <td class="hidden-480"><a class="btn mini green-stripe" href="viewapplication.php?id=<?=$rowdest['id'];?>">View <i class="icon-edit"></i></a> &nbsp;<a onclick="deleteone(<?=$rowdest['id']?>)" href="#" class="btn mini red"><i class="icon-trash"></i> Delete</a></td>
                    </tr>
