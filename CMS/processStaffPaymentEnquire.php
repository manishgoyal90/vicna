        ...
        newWindow.focus();
						...
						<div id="tablesec">
							<table class="table table-striped table-bordered table-hover" id="sample_2">						
								<thead><tr><th>User Id</th><th>Recipt no</th><th>Title</th><th>Status</th><th>Option</th><th>&nbsp;</th></tr></thead>
								<tbody>
								...
								<?php
									...
									<tr class="odd gradeX">
                                        ...
                                        <td class="hidden-480">
											<div class="videoWrapper">VIC<?=$row['sl']?></div> 
										</td>
										...
										<td class="hidden-480">
											<div class="videoWrapper"><?php if($row['answered']){echo("Answered");}else{echo "Not Answered";}?></div> 
										</td>
