							...
							<table class="table table-striped table-bordered table-hover" id="sample_2">						
								<thead>
									<tr>
                                        ...
                                        <th class="hidden-480">Time Sheet</th>
								...
								<?php
									...
									$GetUserSql = "SELECT * FROM staff_available_shift WHERE accept_staffid != '' AND shiftEndTime < NOW() ORDER BY id DESC";
									...
									<tr class="odd gradeX">
										...
										<?php if($rowdest['timeSheets'] != ""){echo "<span style='color:green;font-weight:bold;'>Timesheet Received</span>";}else{echo "<span style='color:red; font-weight:bold;'>Timesheet Due</span>";}	
										?> 
										</td>
										<td class="hidden-480" style="text-align:center"> 
											<a href="completedShiftView.php?Uid=<?=$rowdest['id']?>" class="btn mini green"><i class="icon-edit"></i> View</a>                                      
                                           <!-- <a href="advertiseShiftView1.php?Uid=<?=$rowdest['id']?>&realloc=Yes" class="btn mini blue"> Re-Allocate</a>
											<a href="advertiseShiftView1.php?Uid=<?=$rowdest['id']?>" class="btn mini green"><i class="icon-edit"></i> View & Edit</a>			
                                            <a onclick="cancelShift(<?=$rowdest['id']?>);" href="#" class="btn mini red"><i class="icon-trash"></i> Cancel</a>
											<a onclick="readvertise(<?=$rowdest['id']?>)" href="#" class="btn mini black"> Re-Advertise</a>-->			</td>
                                       </tr>
                                       <?php $ctn++; } ?>
								</tbody>
							</table>
