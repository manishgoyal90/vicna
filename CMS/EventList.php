						...
						<div class="portlet box grey">
							...
							<div class="portlet-body">
								<div class="table-toolbar">
									 <div class="btn-group">
										<a class="btn blue" href="Event.php?mode=add">Add New <i class="icon-plus"></i></a>
									</div>
...
<!--	<script src="assets/plugins/bootstrap-modal/js/bootstrap-modal.js" type="text/javascript" ></script>
	...
	function delselected()
	{
		...
		if(str != "")
		{
			...
			{
				$('.portlet .tools a.reload').click();
				$.post('ajax/delEvent.php',{ feedids : str , mode : 'selected' },
					function(data)
					{
						$('#tablesec').html(data);
	...
	{
		$.post('ajax/statusevent.php',{ stat : stat , id : id });
	}
</script>
	<!-- END JAVASCRIPTS -->
</body>
