				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li>
								<a href="allocatedShifts.php">Allocated Shifts</a> 
								<i class="icon-angle-right"></i>
							</li>
							<li>
								<a href=""><?=$pagetitle?></a>
								...
								<div class="tab-pane row-fluid active" id="tab_1_1">
									...
									<div class="span9">
										<div class="row-fluid"  id="view_profile">
                                            ...
                                            <h3>Advertise Shift Info&nbsp;<button id="" onClick="location.href='advertiseShift.php?id=<?=$rowdest7['id']?>&mode=edit';" class="btn mini blue">Edit <i class="icon-edit"></i></button>&nbsp;</h3>	
												<table  width="100%" cellpadding="3" rules="none" border="0">
                                                    ...
                                                    <tr>
														<td><p><i class="icon-star"></i>&nbsp;Allocated
															</p></td>
														<td><p>:</p></td>
														<td width="">
                                                        <?php 
														...
														?>
                                                            ...
                                                            <h4> Employee ID : <?=$fetch['RegistrationNo'];?></h4>
                                                            
                                                            </p>
                                                       <?php }else{echo '<p style="color:red; font-weight:bold;">NOT ACCEPTED</p>';}?>
                                                        </td>
													</tr>
                                                    <?php if($rowdest7['accept_staffid'] == "" || $_REQUEST['realloc'] == 'Yes'){?>
                                                    <style type="text/css">.bb{ float:left; margin:3px;}</style>
                                                    <tr>
														<td><p><i class="icon-star"></i>&nbsp;New Allocate / Re-Allocate
															</p></td>
														<td><p>:</p></td>
														<td ><p> 
                                                        <form action="" method="post">
                                                        <input type="hidden" name="id" value="<?=$_REQUEST['Uid']?>">
                                                        		<input type="text" class="bb" name="registrationNo" id="registrationNo" placeholder="Enter Employee ID">
