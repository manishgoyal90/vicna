              ...
              <div id="tablesec">
                <table class="table table-striped table-bordered table-hover" id="sample_2">
                  ...
                  <tbody>
					...
					$GetUserSql = "SELECT * FROM hr_feedback ORDER BY id DESC";
                    ...
                    <tr class="odd gradeX">
                     ...
                     <td class="hidden-480"><div class="videoWrapper">
                      ...
                      <td class="hidden-480"><a class="btn mini green-stripe" href="viewFeedbck.php?id=<?=$rowdest['id'];?>">View <i class="icon-edit"></i></a> &nbsp;<a onclick="deleteone(<?=$rowdest['id']?>)" href="#" class="btn mini red"><i class="icon-trash"></i> Delete</a></td>
                    </tr>
...
<script>
    ...
    function deleteone(id)
    {
        ...
        if (cnf)
        {
            ...
            $.post('ajax/delfeedback.php', {feedid: id, mode: 'single'},
            function(data)
            {//deletecinematic
                $('#tablesec').html(data);
                /************************************ Table JS ************************************/
    ...
    function delselected()
    {
        ...
        if (str != "")
        {
            ...
            {
                $('.portlet .tools a.reload').click();
                $.post('ajax/delfeedback.php', {feedids: str, mode: 'selected'},
                function(data)
                {
                    $('#tablesec').html(data);
