					...
					<div class="span12">
						...
						<div class="portlet box grey">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>Banner</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="table-toolbar">
									 <div class="btn-group">
										<a class="btn blue" href="Banner.php?mode=add">Add New <i class="icon-plus"></i></a>
									</div>
						...
						<div id="tablesec">
							<table class="table table-striped table-bordered table-hover" id="sample_2">						
								...
								<?php
									$ctn = 1;
									$GetUserSql = "SELECT * FROM ".TABLE_PREFIX."banner ORDER BY BannerId ASC";
						...
						<td class="hidden-480"><div class="videoWrapper"><?=substr(stripslashes($rowdest['BannerName']),0,30)?></div></td>
