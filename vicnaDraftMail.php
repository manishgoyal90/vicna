		...
		echo "<div style='margin:10px'>$msg_upload</div>";
			  ...
			  ?>
                <div class="col-sm-2" style="background-color:#D2FCFF; min-height:500px;"><br>
                  ...
                  <a style="text-decoration:none;" href="vicnaDraftMail.php"><div class="row" style="padding:5px; background-color:#CCC;"><span class="glyphicon glyphicon-briefcase"></span> Drafts</div></a>
                ...
                <div class="col-sm-10" style="padding:10px;"> 
					<div class="table-responsive">
						<table id="myTable" class="display table" width="100%" >
							...
							<tbody>
						<?php 
							$sql = "SELECT * FROM mailing_draft WHERE mail_from = '".$row['vicnaEmail']."'";
						...
						?>
								...
								<tr>
									<td><a style="text-decoration:none; color:#000;" href="vicnaComposeMail.php?mail_id=<?=base64_encode($fetch['mail_id']);?>"><?=$fetch['mail_subject'];?></a></td>
									<td><a style="text-decoration:none; color:#000;" href="vicnaComposeMail.php?mail_id=<?=base64_encode($fetch['mail_id']);?>"><?=$fetch['mail_to'];?></a></td>
									<td><a style="text-decoration:none; color:#000;" href="vicnaComposeMail.php?mail_id=<?=base64_encode($fetch['mail_id']);?>"><?=date('D H:i:s', strtotime($fetch['mail_date']));?></a></td>
