		...
		echo "<div style='margin:10px'>$msg_upload</div>";
			  ...
			  ?>
                <div class="col-sm-2" style="background-color:#D2FCFF; min-height:500px;"><br>
                  ...
                  <a style="text-decoration:none;" href="vicnaDeleteMail.php"><div class="row" style="padding:5px; background-color:#CCC;"><span class="glyphicon glyphicon-trash"></span> Trash</div></a>
                  <!--------------------------------------------------------------------------------> 
                </div>
                <div class="col-sm-10" style="padding:10px;"> 
					<div class="table-responsive" id="tablesec">
						<table id="myTable" class="display table" width="100%" >
							...
							<tbody>
						<?php 
							$sql = "SELECT * FROM mailing WHERE mail_to = '".$row['vicnaEmail']."' AND del_status='1'";
						...
						?>
								...
								<tr>
									<td><a style="text-decoration:none; color:#000;" href="vicnaDelMailText.php?mail_id=<?=base64_encode($fetch['mail_id']);?>"><?=$fetch['mail_subject'];?></a></td>
									<td><a style="text-decoration:none; color:#000;" href="vicnaDelMailText.php?mail_id=<?=base64_encode($fetch['mail_id']);?>"><?=$fetch['mail_to'];?></a></td>
									<td><a style="text-decoration:none; color:#000;" href="vicnaDelMailText.php?mail_id=<?=base64_encode($fetch['mail_id']);?>"><?=date('D H:i:s', strtotime($fetch['mail_date']));?></a></td>
...
<script type="text/javascript">
    ...
    function deleteone(id)
    {
        ...
        if (cnf)
        {
            ...
            $.post('ajax/deletemail.php', {feedid: id, mode: 'single'},
            function(data)
            {//deletecinematic
                $('#tablesec').html(data);
                /************************************ Table JS ************************************/
